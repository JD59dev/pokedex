...
@Component({
  selector: 'app-kalos',
  templateUrl: './kalos-central.page.html',
  styleUrls: ['./kalos-central.page.scss'],
})
export class KalosCentralPage implements OnInit {
  pokemons = [];
  ...
  ionViewWillEnter() {
    ...
    this.pkmnService.getKalosCentralDex().then(pokemons => {
